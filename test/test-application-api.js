...
function mockApplicationAPI() {
    ...
    nock(serverURL)
        ...
        .reply(200, { token: 'faketoken', application: { id: 'id1', application_type: 'developer', dedicated_workers: true, dedicated_workers_ttl: 70 } });
...
describe('LeIA Application API', () => {
    ...
    describe('login()', () => {
        it('should return a token and an Application', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((result) => {
                ...
                result.dedicatedWorkersTtl.should.be.eql(application.dedicated_workers_ttl)
                done()
            })
        });
    ...
    describe('adminGetApplication()', () => {
        it('should return a list of applications', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                leiaAPI.adminGetApplications().then((result) => {
                    ...
                    result.applications[0].dedicatedWorkersTtl.should.be.eql(application.dedicated_workers_ttl)
                    done()
                })
            })
        });
        ...
        it('should return a list of applications when application_id is provided', (done) => {
            var leiaAPI = new LeiaAPI(serverURL)
            leiaAPI.login('mockApiKey').then((_) => {

                leiaAPI.adminGetApplications(null, null, null, 'id1').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when email is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, 'test@test.com').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when application_name is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, null, 'appName').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when first_name is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, null, null, 'Jean').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when last_name is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, null, null, null, 'test').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when application_type is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, null, null, null, null, 'admin').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when created_before is provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(null, null, null, null, null, null, null, null, null, null, '2018-10-10T10:10:10').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
        ...
        it('should return a list of applications when all parameters are provided', (done) => {
            ...
            leiaAPI.login('mockApiKey').then((_) => {
                ...
                leiaAPI.adminGetApplications(20, 20, ['applicationName', '-email'], 'id1', 'test@test.com', 'appName', 'Jean', 'test', 'admin', '2018-10-10T10:10:10', '2018-10-10T10:10:10').then((result) => {
                    result.contentRange.offset.should.be.eql(0)
                    result.contentRange.limit.should.be.eql(1)
                    result.contentRange.total.should.be.eql(1)
                    result.applications.should.be.a('array');
    ...
    describe('adminAddApplication()', () => {
        it('should return an Application', (done) => {
            var leiaAPI = new LeiaAPI(serverURL)
            leiaAPI.login('mockApiKey').then((_) => {
                leiaAPI.adminAddApplication("test@test.com", "appName", "admin", "jean", "test", "http://test.com", true, 70).then((result) => {
                    result.should.be.a('object');
                    result.id.should.be.eql(application.id)
                    result.creationTime.should.be.eql(application.creation_time)
                    result.applicationName.should.be.eql(application.application_name)
        ...
        it('should return a 400 status when LeiaAPI returns a 400 status', (done) => {
            var leiaAPI = new LeiaAPI(serverURL)
            leiaAPI.login('mockApiKey').then((_) => {
                leiaAPI.adminAddApplication("test@test.com", "appName4", "admin", "jean", "test", "http://test.com", true, 70).then((_) => {
                }).catch((error) => {
                    error.status.should.be.eql(400)
                    done()
                })
        ...
        it('should return a 401 status when LeiaAPI returns a 401 status', (done) => {
            var leiaAPI = new LeiaAPI(serverURL)
            leiaAPI.login('mockApiKey').then((_) => {
                leiaAPI.adminAddApplication("test@test.com", "appName2", "admin", "jean", "test", "http://test.com", true, 70).then((_) => {
                }).catch((error) => {
                    error.status.should.be.eql(401)
                    done()
                })
        ...
        it('should return a 409 status when LeiaAPI returns a 409 status', (done) => {
            var leiaAPI = new LeiaAPI(serverURL)
            leiaAPI.login('mockApiKey').then((_) => {
                leiaAPI.adminAddApplication("test@test.com", "appName3", "admin", "jean", "test", "http://test.com", true, 70).then((_) => {
                }).catch((error) => {
